...
# FIXED: Only set DEBUG once, from environment variable
...
# ALLOWED_HOSTS - Fixed to handle Render domain properly
...
# FIXED: Added WhiteNoise for static files
MIDDLEWARE = [
...
# FIXED: Database configuration - Use PostgreSQL if DATABASE_URL exists
...
# WhiteNoise compression (optional but recommended)
...
# FIXED: Stripe settings - correct spelling!
